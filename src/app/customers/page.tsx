        ...
        actions={
          <>
            ...
            <div className="relative">
              <input type="text" placeholder="Search customers..." className="pl-10 pr-4 py-2 rounded-lg bg-surface-900 border border-surface-700/50 text-sm text-surface-100 placeholder-surface-300/50 focus:outline-none focus:border-brand-500 w-64" />
            ...
            <button className="admin-only px-4 py-2 text-sm rounded-lg gradient-accent text-white font-medium hover:opacity-90 transition flex items-center gap-2">
                  ...
                  <td className="px-5 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="p-1.5 rounded hover:bg-surface-700 transition" title="Invoice">
                        <svg className="w-4 h-4 text-surface-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1" /></svg>
                      </button>
                    </div>
                  </td>
                </tr>
